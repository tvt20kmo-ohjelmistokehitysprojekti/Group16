...
public:
    ...
    void setupUi(QWidget *SiirtoForm)
    {
        ...
        label->setFont(font);
        label_2 = new QLabel(SiirtoForm);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(280, 90, 41, 21));
        ...
        btnSiirto->setGeometry(QRect(230, 240, 141, 31));
    ...
    void retranslateUi(QWidget *SiirtoForm)
    {
        ...
        label_2->setText(QCoreApplication::translate("SiirtoForm", "Siirto", nullptr));
